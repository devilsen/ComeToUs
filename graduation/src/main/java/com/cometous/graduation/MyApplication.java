...
public class MyApplication extends Application {
    ...
    private void imageInit() {
        File cacheDir = StorageUtils.getOwnCacheDirectory(getApplicationContext(), "comeToUs/image");

        ImageLoaderConfiguration config = new ImageLoaderConfiguration
                .Builder(this)
                .memoryCacheExtraOptions(460, 270) // max width, max height，即保存的每个缓存文件的最大长宽
    ...
    public void setImageOption() {
        ...
        options = new DisplayImageOptions.Builder()
                ...
                .showImageForEmptyUri(R.drawable.img_error)//设置图片Uri为空或是错误的时候显示的图片
